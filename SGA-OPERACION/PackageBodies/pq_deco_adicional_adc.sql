create or replace package body operacion.pq_deco_adicional_adc is 
  /*******************************************************************************
  ...
  7.0      2016-01-22  Leonardo Silvera  Paul Moya          PROY-17652 IDEA-22491 - ETAdirect
  *******************************************************************************/
 ...
 begin
  ...
  --------------------------------------------------------------------------------
  function get_codsrv return linea_paquete.idlinea%type is
    l_codsrv tystabsrv.codsrv%type;
