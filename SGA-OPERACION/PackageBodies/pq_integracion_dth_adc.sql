CREATE OR REPLACE package body OPERACION.pq_integracion_dth_adc as
  /************************************************************
    ...
    END IF;
     ...
     i.numsec = v_av_num_sec; --7.0 i.numero =  av_num_sec;
       ...
       if ln_tipo_trab = ln_tipo_trab_te then
            ...
            UPDATE INSSRV SET CODSUC = vv_CODSUC
