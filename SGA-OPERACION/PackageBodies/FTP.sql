CREATE OR REPLACE PACKAGE BODY OPERACION.ftp AS
  -- --------------------------------------------------------------------------
  ...
  BEGIN
    ...
    l_result := UTL_TCP.write_text(p_conn,
  ...
  function send_file_scp(host                    varchar2,
                         usuario                 varchar2,
                         password                varchar2,
                         ruta_servidor_local     varchar2,
                         archivo_servidor_local  varchar2,
                         archivo_servidor_remoto varchar2) return varchar2 as
    language java name 'com.creo.operacion.SFTP.enviarFichero(java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String) return java.lang.String';

  function get_file_scp(host                    varchar2,
                         usuario                 varchar2,
                         password                varchar2,
                         ruta_servidor_local     varchar2,
                         archivo_servidor_local  varchar2,
                         archivo_servidor_remoto varchar2) return varchar2 as
    language java name 'com.creo.operacion.SFTP.recibirFichero(java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String) return java.lang.String';
