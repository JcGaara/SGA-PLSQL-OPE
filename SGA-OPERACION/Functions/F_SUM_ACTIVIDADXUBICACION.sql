CREATE OR REPLACE FUNCTION OPERACION.f_sum_actividadxubicacion( a_codot in number, a_codpre in number, a_idubi in number, a_moneda in char, a_tipo in number)  RETURN NUMBER IS
